export const articles = [
    ...
    {
        id: "best-practices-for-account-security",
        title: "Mejores prácticas para la seguridad de la cuenta",
        category: "My Account",
        excerpt:
            "Este es un artículo de ejemplo. Está destinado a demostrar algunos de los elementos clave de estilo de KnowAll, la base de conocimientos...",
    ...
    {
        id: "change-your-account-email-address",
        title: "Cambiar la dirección de correo de tu cuenta",
        category: "My Account",
        excerpt:
            "Este es un artículo de ejemplo. Está destinado a demostrar algunos de los elementos clave de estilo de KnowAll, la base de conocimientos...",
    ...
    {
        id: "export-and-back-up-account-data",
        title: "Exportar y respaldar datos de la cuenta",
        category: "My Account",
        excerpt:
            "Este es un artículo de ejemplo. Está destinado a demostrar algunos de los elementos clave de estilo de KnowAll, la base de conocimientos...",
    ...
    {
        id: "recover-your-username-or-password",
        title: "Recuperar tu nombre de usuario o contraseña",
        category: "My Account",
        excerpt:
            "Este es un artículo de ejemplo. Está destinado a demostrar algunos de los elementos clave de estilo de KnowAll, la base de conocimientos...",
    ...
    {
        id: "reactivate-or-deactivate-an-account",
        title: "Reactivar o desactivar una cuenta",
        category: "My Account",
        excerpt:
            "Este es un artículo de ejemplo. Está destinado a demostrar algunos de los elementos clave de estilo de KnowAll, la base de conocimientos...",
